...
# 配置下载源
readonly BASE_URL="https://raw.githubusercontent.com/imonior/PublicIP_Monitor/main"
...
echo "      vi $CONFIG_FILE"
echo ""
echo "   2. 启用推送方式（设置为true，默认关闭false）:"
echo "      ENABLE_DINGTALK=\"false\"      # 钉钉"
echo "      ENABLE_WECHAT=\"false\"        # 企业微信"
echo "      ENABLE_TELEGRAM=\"false\"      # Telegram"
echo "      ENABLE_IYUU=\"false\"          # IYUU"
echo "      ENABLE_SERVERCHAN=\"false\"    # Server酱"
echo ""
...
echo ""
echo "📖 项目地址: https://github.com/imonior/PublicIP_Monitor"
echo "🐛 问题反馈: https://github.com/imonior/PublicIP_Monitor/issues"
echo "========================================"
